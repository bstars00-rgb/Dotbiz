 ...
 *
 * ⚠ 경계 (2026-04-29 확정):
 *   이 페이지는 현재 DOTBIZ 프로토타입 안에서 시연 중이지만,
 *   추후 별도 ELLIS DB / 백오피스 앱으로 이전될 예정.
 *   - DOTBIZ 사용자(Master/OP/Accounting)에게는 영원히 노출 X
 *   - `user?.isInternal` 가드로 모든 진입 차단
 *   - 분리 작업은 코드 이동 수준 (보안 모델 이미 정합)
 *
