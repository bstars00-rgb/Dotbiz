...
const navSections: NavSection[] = [
  {
    ...
    items: [
      ...
      /* Tickets는 OP(고객사) + EllisOP(ELLIS 처리 전담) + Master(조회) + Accounting(분쟁만) 노출.
       * EllisAdmin은 시스템 관리자 — 티켓 운영 X, CMS만. */
      { i18nKey: "nav.tickets",     label: "Tickets",     icon: Ticket,          path: "/app/tickets", roles: ["Master", "OP", "Accounting", "EllisOP"] },
    ],
  },
  {
    id: "admin",
