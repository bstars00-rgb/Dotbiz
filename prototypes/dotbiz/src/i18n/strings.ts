...
const strings: Record<string, Record<Locale, string>> = {
  ...
  "nav.team":       { EN: "Master Account", KO: "마스터 계정", JA: "マスターアカウント", ZH: "主账户管理", VI: "Tài khoản Master" },
  ...
  "nav.reviewMod":    { EN: "Review Moderation", KO: "리뷰 검수", JA: "レビュー検閲", ZH: "评论审核", VI: "Kiểm duyệt đánh giá" },
