...
const strings: Record<string, Record<Locale, string>> = {
  ...
  "nav.myAccount": { EN: "Master Account", KO: "마스터 계정", JA: "マスターアカウント", ZH: "主账户", VI: "Tài khoản Master" },
  ...
  "page.myAccount": { EN: "Master Account", KO: "마스터 계정", JA: "マスターアカウント", ZH: "主账户", VI: "Tài khoản Master" },
