...
export const guides: Guide[] = [
  ...
  {
    id: "g-notifications",
    title: "Tune your notification settings",
    category: "Alerts",
    icon: Bell,
    gradient: "linear-gradient(135deg, #F43F5E, #F59E0B)",
    summary: "Pick which alerts you want and through which channels. Stop the spam, keep the critical.",
    estimatedMin: 3,
    steps: [
      {
        title: "Open My Account → Notifications",
        description: "Each user has their own settings. Masters can also see all team alerts separately.",
        actionPath: "/app/my-account?tab=notifications",
        actionLabel: "Open Notifications Settings",
      },
      {
        title: "Toggle each alert on/off",
        description: "Grouped by category (Settlement / Booking / Dispute / Account). P0 (red) = critical, P1 (amber) = important, P2 = informational.",
      },
      {
        title: "Pick channels per alert",
        description: "In-app / Email / SMS / Slack. Some critical alerts (🔒 Locked) always require at least Email — for your own protection.",
        callout: { type: "warning", text: "Credit Critical, Payment Deadline Today, Hotel Cancelled — these are locked on by design. You can only change which channels deliver them." },
      },
      {
        title: "Set Quiet Hours (optional)",
        description: "Suppress non-critical alerts during a time window (e.g. 22:00–08:00). P0 alerts always deliver regardless.",
      },
    ],
  },
