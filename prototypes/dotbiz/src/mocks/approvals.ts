...
export const APPROVAL_ITEMS: ApprovalItem[] = [
  ...
  /* ── Policy ── */
  {
    key: "ELS_DAILY_TRANSFER_LIMIT",
    category: "Policy",
    label: "P2P Daily Transfer Limit",
    description: "Max ELS one OP can send per day (anti-abuse).",
    currentValue: "1,000 ELS / day",
    approvers: ["CFO"],
    impact: "Medium",
    reviewCadence: "As needed",
    budgetImpactHint: "Raises AML/KYC risk if too high",
  },
  {
    key: "ELS_TRANSFER_FEE_PCT",
    category: "Policy",
    label: "P2P Transfer Fee",
    description: "Percentage fee charged on ELS-to-ELS transfers.",
    currentValue: "0% (free)",
    approvers: ["CFO", "CEO"],
    impact: "Low",
    reviewCadence: "Annual",
    budgetImpactHint: "1% fee on ₩100M monthly transfer = ₩1M revenue",
  },
  {
...
export const approvalRequests: ApprovalRequest[] = [
  ...
  {
    id: "apr-020",
    itemKey: "ELS_TRANSFER_FEE_PCT",
    requestedBy: "cfo@ohmyhotel.com", requestedByName: "Su-min Park (CFO)",
    requestedAt: "2026-03-18 10:00:00",
    currentValue: "0% (free)",
    proposedValue: "1% transfer fee",
    justification: "Revenue opportunity from OP-to-OP transfers.",
    impactAnalysis: "Est ₩1M/month revenue at current volume. But may suppress P2P activity which drives engagement.",
    status: "Rejected", resolvedAt: "2026-03-20 09:00:00",
    signatures: [
      { approver: "CFO", approverName: "Su-min Park (CFO)",       signedAt: "2026-03-18 10:00:00", decision: "Approved" },
      { approver: "CEO", approverName: "Tae-hoon Lee (CEO)",       signedAt: "2026-03-20 09:00:00", decision: "Rejected", comment: "Keep transfers free — they're a core stickiness lever. Revisit only if abuse emerges." },
    ],
  },
];
